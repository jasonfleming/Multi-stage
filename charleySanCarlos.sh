...
#                            General setting   
#
ID=charleyPCHNewBCexteact    # simulation ID (the name of the coastal estuary)
estuary="SanCarlos"   # The name of the estuary
HINDCASTLENGTH=22        # total length of stage one simulation       
HOTSTARTFORMAT=binary    # Hotstart file format (netCDF not supported yet)
platform=coconut         #
#                 
NCPU=45                  # Number of CPUs to use (same for stage one and two)
...
s2_INPDIR=/home/ptaeb/multi.stage/input/domain/Port.Charlotte_Fort.Myers/         # dir containing stage 2 mesh, nodal attribute, swan template 
met_INPDIR=/home/ptaeb/multi.stage/input/MET/charley2004/       # dir containing meteorological forcing
#
#
# ----------------------------------------------------------------
#                 S T A G E   O N E     I N P U T S
#
CSDATE=2004072400                      # cold start time
S1_dt=20                               # time step size
s1_grd=adjstd.ec95.v7.grd              # grid name
s1_cntrl=ec95.fort.15_temp             # ctntrol file
s1_ndlattr=adjstd.ec95.v7.13           # nodall atribute input file   
#
# ----------------------------------------------------------------
#                 S T A G E   T W O     I N P U T S
#
S2_dt=1  
s2_grd=portcharlotte.grd       
s2_cntrl=control.adcirc.15
s2_ndlattr=portcharlotte.13
...
MET="NHC"                     # Meteorology type: [gridded/NHC]
EVENTDATE=2004081000              # Meteorology start time
...
#
NHCmet=fort.22_20040810_20040815 
#
# ---------------------------------------------------------------
...
BNNAME=FortMyersPortCharlotte_BC_LatLon
#-------------------------------------------------------------------
