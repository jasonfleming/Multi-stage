...
#                            General setting   
#
ID=IRLMatthew                 # simulation ID (the name of the coastal estuary)
...
met_INPDIR=/home/ptaeb/multi.stage/input/MET/            
#
...
EVENTDATE=2016100500             # (NWS=19, 20) start date of the event simulation 
#
# ---------------------------------------------------------------
